...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    p {{ color:#4b5563; line-height:1.55; max-width:880px; margin:0; }}
...
<body><main>
  ...
  <section class="stats">
    ...
    <div class="stat"><span>Blocked paths</span><b>{analysis['status_counts']['block']}</b></div>
    <div class="stat"><span>Reviewer handoffs</span><b>{analysis['status_counts']['review']}</b></div>
  </section>
  <table>
